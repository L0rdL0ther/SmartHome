...
import { Home, Key, Mail, Eye, EyeOff } from 'lucide-react';
...
const Login = ({ onLoginSuccess, onNavigateToSignUp }: LoginProps) => {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      // Login success - call the success handler if provided
      if (onLoginSuccess) {
        onLoginSuccess();
      }
    } catch (err) {
      ...
      >
        <div className="p-8">
          <div className="text-center mb-8">
            ...
            <p className="text-gray-500 text-sm">Sign in to your Smart Home account</p>
          </div>
